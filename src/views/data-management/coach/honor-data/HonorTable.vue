 ...
 * @Last Modified by: 唐云
 * @Last Modified time: 2021-09-28 10:45:27
 荣誉记录
 */
<template>
  <div>
...
import { getCoachHonor, deleteCoachHonor } from '@/api/data-management/coach'
...
const {
  ...
  handleCreate,
  handleUpdate
} = useBaseHooks({ reqFn: getCoachHonor, searchData, formDataDefault })
