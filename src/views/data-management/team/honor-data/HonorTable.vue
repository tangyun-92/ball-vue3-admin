 ...
 * @Last Modified by: 唐云
 * @Last Modified time: 2021-09-28 09:31:08
 荣誉记录
 */
<template>
  <div>
...
import { getTeamHonor, deleteTeamHonor } from '@/api/data-management/team'
...
const {
  ...
  handleCreate,
  handleUpdate
} = useBaseHooks({ reqFn: getTeamHonor, searchData, formDataDefault })
